  ...
  <DashboardLayout>
    <template #default>
      <v-row>
        ...
        <v-col v-for="product in products" :key="product.product_id" cols="12" sm="6" md="4" lg="3">
          <v-card
      ...
      <v-dialog v-model="dialog" max-width="500" persistent>
        <v-card class="rounded-lg pa-4 elevation-2">
          ...
          <v-card-actions class="d-flex justify-end mt-4">
            <v-btn variant="text" @click="dialog = false" class="text-grey-darken-2">Cancel</v-btn>
